...
namespace OAuth2
{
    ...
    static public class OAuth2Static
    {
        private static Regex rx = new Regex(".*\"access_token\"\\s*:\\s*\"([^\"]+)\".*");

        static public string GetClientCredentials(string client_id, string client_secret, string resourceLocal, string subscriptionKey, string tokenUrl, string postUrl)
        {
